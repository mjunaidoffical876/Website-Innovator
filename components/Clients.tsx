...
const clients = ["Logo 1", "Logo 2", "Logo 3", "Logo 4", "Logo 5"];
        ...
        <section className="py-20 bg-white border-y border-zinc-100">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    <p className="text-zinc-400 font-bold uppercase tracking-widest text-sm">Empresas que confían en nosotros</p>
                </div>
                <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all cursor-pointer">
                    {clients.map((c, i) => (
                        <motion.div
                            ...
                            className="font-bold text-3xl text-zinc-300 pointer-events-none"
                        >
                            {c}
                        </motion.div>
                    ))}
